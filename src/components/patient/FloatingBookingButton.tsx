...
export const FloatingBookingButton = ({
  ...
  // If AI chat is disabled, just open booking modal directly without dropdown
  if (!hasAIChat) {
    return (
      <>
        ...
        <div className={cn("fixed bottom-20 right-4 z-50 md:hidden", className)}>
          ...
          <Button
            ...
            onClick={() => onBookAppointment ? onBookAppointment() : setBookingModalOpen(true)}
            size="icon"
    ...
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-56 mb-2">
          ...
          <DropdownMenuItem onClick={() => onBookAppointment ? onBookAppointment() : setBookingModalOpen(true)} className="cursor-pointer">
