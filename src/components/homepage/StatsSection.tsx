...
import { Users, Clock, Star, TrendingUp, CheckCircle, Zap } from "lucide-react";
export const StatsSection = () => {
  ...
  return <section className="py-20 sm:py-24 bg-white/5 backdrop-blur-sm">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {stats.map((stat, index) => <Card key={index} className="glass-card border-0 hover:shadow-elegant transition-all duration-300 group">
