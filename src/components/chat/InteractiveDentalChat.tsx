      ...
      <div className="space-y-4 max-w-4xl mx-auto pb-4">
        {messages.map((message) => {
          ...
          return (
            ...
            >
              <div
                className={`flex items-start gap-3 max-w-[85%] ${message.is_bot ? "" : "flex-row-reverse"
                  }`}
              >
                ...
                <Card className={`border-none shadow-md ${message.is_bot
                  ...
                  <CardContent className="p-4 flex flex-col gap-2">
                    ...
                    {message.message_type === 'success' && (
                      <Badge
                        variant="secondary"
                        className={`bg-green-100 text-green-800 border-green-200 ${message.is_bot ? "self-start" : "self-end"
                          }`}
                      >
