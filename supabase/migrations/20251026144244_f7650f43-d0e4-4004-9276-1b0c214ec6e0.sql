-- Fix automatic business owner assignment for all new users
-- New users should be patients by default, NOT business owners
...
BEGIN
  ...
  IF new.raw_user_meta_data->>'create_business' = 'true' THEN
    ...
    BEGIN
      ...
      -- Assign provider role when creating a business
      INSERT INTO public.user_roles (user_id, role)
