...
-- =============================================================================
-- ✅ Dentists table: Removed public access, added relationship-based access
-- ✅ Profiles table: Restricted to own profile + dentist-patient relationships  
-- ✅ Insurance providers: Limited to dentists and patients with recent appointments
-- ✅ Appointment slots: Maintained booking functionality but requires authentication
-- =============================================================================