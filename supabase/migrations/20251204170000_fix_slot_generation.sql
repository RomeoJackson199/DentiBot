-- Fix generate_daily_slots to preserve booked appointments
...
BEGIN
  ...
  -- CRITICAL FIX: Only delete AVAILABLE slots. 
  ...
  -- Note: Existing booked slots remain due to the restricted DELETE above
