-- Fix RLS policies for conversation creation (corrected syntax)
...
-- Drop and recreate profiles view policy to allow reading for messaging
DROP POLICY IF EXISTS "Users can view profiles for messaging" ON public.profiles;
CREATE POLICY "Users can view profiles for messaging" ON public.profiles
