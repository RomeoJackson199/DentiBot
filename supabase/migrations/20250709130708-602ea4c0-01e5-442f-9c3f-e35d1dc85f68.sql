...
-- Insert sample dentist schedules
INSERT INTO public.profiles (user_id, email, first_name, last_name, role) 
VALUES 
  (gen_random_uuid(), 'dr.martin@dentiste.fr', 'Pierre', 'Martin', 'dentist'),
  (gen_random_uuid(), 'dr.durand@dentiste.fr', 'Marie', 'Durand', 'dentist');

-- Get the inserted dentist profile IDs and create dentist records
INSERT INTO public.dentists (profile_id, specialization, license_number)
SELECT id, 'Dentisterie générale', 'FR123456'
FROM public.profiles WHERE email = 'dr.martin@dentiste.fr'
UNION ALL
SELECT id, 'Orthodontie', 'FR789012'
FROM public.profiles WHERE email = 'dr.durand@dentiste.fr';
