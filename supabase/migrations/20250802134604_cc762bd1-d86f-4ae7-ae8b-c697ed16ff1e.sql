...
BEGIN
    ...
    -- Create medical records for Virginia (using valid record types)
    ...
    (
        virginia_profile_id,
        dentist_id,
        'Dental Cleaning - February 2024',
        'Professional dental cleaning and plaque removal',
        'Routine cleaning completed. Moderate plaque buildup removed. Gums healthy.',
